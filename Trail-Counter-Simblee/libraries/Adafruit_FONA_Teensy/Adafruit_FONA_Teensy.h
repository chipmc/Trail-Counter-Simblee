...
//  To use Teensy, do a global replace for SoftwareSerial to HardwareSerial
...
//#define Adafruit_FONA_Teensy_DEBUG
...
class Adafruit_FONA_Teensy : public Stream {
 public:
#if ARDUINO >= 100
  Adafruit_FONA_Teensy(HardwareSerial *, int8_t r);
#else
  Adafruit_FONA_Teensy(NewSoftSerial *, int8_t r);
#endif
